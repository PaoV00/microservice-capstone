...
//
//            Weather weather = locationService.getWeather(location1.getAddress().getCity(), location1.getAddress().getStateCode(), location1.getAddress().getCountryCode());
//            location1.setWeather(weather);
//
